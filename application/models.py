...
class DataLogHistorical(db.Model):
    '''
    Model creates the database table for storing of historical data logged from temperature, humidity, and CO2 sensors. Entries are classified with the following columns:
        - Sample #
        - Local time of collection
        - Realtime temperature in Fahrenheit
        - Realtime relative humidity as a percentage
